...
export class CardSet implements ICardSet {
  cards: Card[] = [
    ...
    new Card(
      CardTypeEnum.Double,
      CardTypeDescriptions.Double,
      undefined,
      "../../../assets/cards/double.svg"
    ),
    new Card(
      CardTypeEnum.Double,
      CardTypeDescriptions.Double,
    ...
    new Card(
      CardTypeEnum.ChangeDirection,
      CardTypeDescriptions.ChangeDirection,
      undefined,
      "../../../assets/cards/reverse.svg"
    ),
    new Card(
      CardTypeEnum.ChangeDirection,
      CardTypeDescriptions.ChangeDirection,
